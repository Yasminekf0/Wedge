...
export const exampleProfile: ProofProfile = {
  ...
  claims: [
    ...
    },
    {
      id: "c3",
      section: "projects",
      text: "Rust crate that turns any CSV into a tiny SQLite database.",
      subtext: "1.2k stars on crates.io. Mostly used by data folks who don't want pandas.",
      ...
      evidence: [
        {
          type: "repo",
          title: "csv2lite",
          description: "One binary, infers schema, handles 5GB files without blinking.",
    ...
    },
    {
      id: "c5",
      section: "projects",
      text: "Self-hosted Spotify-for-podcasts that my partner actually uses.",
      subtext: "Runs on a Raspberry Pi in my closet. Auto-downloads, transcripts, sleep timer.",
      ...
      evidence: [
        {
          type: "repo",
          title: "podpie",
          description: "Go backend, SvelteKit web client, Whisper for transcripts.",
          url: "https://github.com/AntennaPod/AntennaPod",
          language: "Go",
          logo: ghAvatar("AntennaPod"),
        },
      ],
    },
    {
